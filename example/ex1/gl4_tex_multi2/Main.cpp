...
int	CMain::Init()
{
	...
	MAKE_ARG3(args, (char*)MEDIA_DIR"shader/09sl_vs.glsl", (char*)MEDIA_DIR"shader/09sl_fs.glsl", (char**)attlist);
...
int	CMain::Render()
{
	...
	//PLC_TEXTURE	us_t0 = NULL;
	//PLC_TEXTURE	us_t1 = NULL;
	//PLC_TEXTURE	us_t2 = NULL;
	//PLC_TEXTURE	us_t3 = NULL;
	//LCXCOLOR	us_tc(1,1,1,1);
	...
	m_pEft->Int("un_nor", un_nor);
	m_pEft->Int("un_dif", un_dif);
	m_pEft->Int("un_tx0", un_tx0);
	m_pEft->Int("un_tx1", un_tx1);

	m_pEft->Int("un_sc", un_sc);
	m_pEft->Int("un_s0", un_s0);
	m_pEft->Int("un_s1", un_s1);
	m_pEft->Int("un_s2", un_s2);
	m_pEft->Int("un_s3", un_s3);

	m_pEft->Color  ("us_tc", &us_tc);
	m_pEft->Texture("us_t0", 0, us_t0);
	m_pEft->Texture("us_t1", 1, us_t1);
	m_pEft->Texture("us_t2", 2, us_t2);
	m_pEft->Texture("us_t3", 3, us_t3);
