...
public:
    ...
    */
	...
	//(M)::AFEW 2014-09-16
	XMLError LoadBuffer(char* buf, long length);
...
XMLDocument* Txml_CreateDoc     ( char* buf, long length);						// new XMLDocument and LoadBuffer
int          Txml_Release       ( XMLDocument** doc);							// release document
XMLElement*  Txml_FindRoot      ( XMLDocument*);								// new XMLDocument and LoadBuffer

int          Txml_ElementValueB ( XMLElement* elm, char* attrib);				// get the boolean value
int          Txml_ElementValueI ( XMLElement* elm, char* attrib);				// get the integer value
float        Txml_ElementValueF ( XMLElement* elm, char* attrib);				// get the float value
double       Txml_ElementValueD ( XMLElement* elm, char* attrib);				// get the double value
const char*  Txml_ElementValueS ( XMLElement* elm, char* attrib);				// get the string value
}	// tinyxml2
